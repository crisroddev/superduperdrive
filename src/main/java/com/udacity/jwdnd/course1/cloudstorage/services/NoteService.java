...
public class NoteService {
  ...
  public Notes uploadNote(String noteTitle, String noteDescription, Integer userId) throws IOException {
    Notes newNote = new Notes(noteTitle, noteDescription, userId);
    try {
  ...
  public void updateNote(Integer noteId, String noteTitle, String noteDescription, Integer userId) throws IOException {
    Notes updateNote = new Notes(noteId, noteTitle, noteDescription, userId);
    try {
  ...
  public List<Notes> getAllNotes(Integer userId) { return noteMapper.findNotesByUserId(userId);}
