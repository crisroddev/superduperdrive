...
public class FileService {
  ...
  public void uploadFile(MultipartFile multipartFile, Integer userId) throws Exception {
    Files newFile = new Files(multipartFile.getOriginalFilename(), multipartFile.getContentType(), multipartFile.getSize(), multipartFile.getBytes(), userId);
    try {
  ...
  public Files getFileById(Integer fileId) { return fileMapper.findById(fileId); }

  public List<Files> getAllFiles(Integer userId) { return fileMapper.findFilesByUserId(userId); }
